<div class="container d-flex flex-wrap flex-xl-nowrap align-items-center justify-content-between">
    <a class="brand header_logo d-flex align-items-center" href="<?php echo e(route('home')); ?>">
                    <span class="logo">
                ...
                <div class="dropdown-menu collapse" id="pagesMenu">
                    <ul class="dropdown-list">
                        ...
                        <li class="list-item nav-item" data-page="contacts">
                            <a class="dropdown-item" href="<?php echo e(route('contacts')); ?>">Contacts</a>
                        </li>
                    </ul>
                </div>
            </li>
    ...
    <div class="header_user d-flex justify-content-end align-items-center">
        ...
        <a class="header_user-action d-inline-flex align-items-center justify-content-center" href="<?php echo e(route('wishlist')); ?>">
...
</div><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/front/partials/menu-header.blade.php ENDPATH**/ ?>