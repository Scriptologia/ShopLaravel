<?php $__env->startSection('title', 'About | Herbalist'); ?>
<?php $__env->startSection('data-page', 'about'); ?>
                ...
                <div class="container">
                    <div class="sale_grid d-grid">
                        <div class="sale_header">
                            ...
                            <a class="sale_header-btn btn" href="<?php echo e(route('products')); ?>">Shop Now</a>
                        </div>
                        <div class="sale_grid-item sale_grid-item--pm">
                            ...
                            <div class="sale_grid-item_content d-flex flex-column justify-content-end">
                                ...
                                <div class="wrapper d-flex flex-column">
                                    ...
                                    <a class="btn--underline" href="<?php echo e(route('products')); ?>">Shop now</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="guide section">
                <div class="container d-flex flex-column-reverse flex-lg-row">
                    <div class="guide_media">
                        <picture>
                            <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                            <img class="lazy guide_media-img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="media" />
                        </picture>
                        <span class="underlay">
                            <span class="underlay_circle underlay_circle--accent"></span>
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="1" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Richard Edwards" />
                                    </picture>
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="2" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Maria White" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="3" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Chris Gibson" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="4" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Linda Nelson" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="5" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Katrina King" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="6" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="John Anderson" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="7" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Randy Stewart" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                        ...
                        <li class="team_list-item col-12 col-md-6 col-xl-4 col-xxl-3" data-order="8" data-aos="fade-up">
                            <div class="wrapper d-flex flex-column">
                                <div class="team_list-item_img">
                                    <picture>
                                        <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                        <img class="lazy img" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="Zachary Wagner" />
                                    </picture>
                                    <div class="overlay d-flex justify-content-center align-items-end">
                                        <ul class="overlay_socials d-flex justify-content-center align-items-center">
                                            <li class="list-item">
                    ...
                    <div class="swiper-wrapper">
                        <div class="instagram_slider-slide swiper-slide">
                            <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                                <picture>
                                    <source data-srcset="front/img/placeholder.jpg" srcset="front/img/placeholder.jpg" type="image/webp" />
                                    <img class="lazy" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="instagram post" />
                                </picture>
...
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('front/css/about.min.css')); ?>" />
<?php $__env->stopPush(); ?>

<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/front/about.blade.php ENDPATH**/ ?>