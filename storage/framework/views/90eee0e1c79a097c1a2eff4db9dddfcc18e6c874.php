...
<script src="<?php echo e(URL::asset('admin/assets/js/pages/form-advanced.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('admin/assets/js/pages/form-input-spin.init.js')); ?>"></script>
<!-- input flag init -->
<script src="<?php echo e(URL::asset('admin/assets/js/pages/flag-input.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/forms-advanced.blade.php ENDPATH**/ ?>