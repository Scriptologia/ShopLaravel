...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('/admin/assets/libs/aos/aos.min.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('/admin/assets/libs/aos/aos.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/admin/assets/libs/prismjs/prismjs.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/admin/assets/js/pages/animation-aos.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/advance-ui-animation.blade.php ENDPATH**/ ?>