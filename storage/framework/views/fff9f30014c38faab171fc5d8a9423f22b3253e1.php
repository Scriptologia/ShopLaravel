<div class="shop_aside">
    <div class="shop_aside-wrapper collapse" id="shopFilters">
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('search-products')->html();
} elseif ($_instance->childHasBeenRendered('l3754014839-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3754014839-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3754014839-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3754014839-0');
} else {
    $response = \Livewire\Livewire::mount('search-products');
    $html = $response->html();
    $_instance->logRenderedChild('l3754014839-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <div class="shop_aside-block shop_aside-block--categories">
            <h4 class="shop_aside-block_header d-flex align-items-center">
                ...
                <?php echo app('translator')->get('front.product.product-categories'); ?>
            </h4>
            <ul class="list">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="list-item d-flex align-items-center">
                    <input type="radio" wire:model="categoryIdSelected" id="<?php echo e($category->id); ?>" value="<?php echo e($category->id); ?>" name="category-id-selected" />
        ...
        <div class="shop_aside-block shop_aside-block--types">
            <h4 class="shop_aside-block_header d-flex align-items-center">
                ...
                <?php echo app('translator')->get('front.filter.plant-type'); ?>
            </h4>
            <ul class="list">
                <li class="list-item">
        ...
        <div class="shop_aside-block shop_aside-block--thc">
            ...
            <ul class="list">
                <li class="list-item">
                    <input type="radio" id="010-thc" name="thc" wire:model="thc" value="[0, 1000]"/>
                    <label for="010-thc">0% - 10%</label>
                </li>
                <li class="list-item">
                    <input type="radio" id="1020-thc" name="thc" wire:model="thc" value="[1000, 2000]"/>
                    <label for="1020-thc">10% - 20%</label>
                </li>
                <li class="list-item">
                    <input type="radio" id="3040-thc" name="thc" wire:model="thc"value="[2000, 4000]"/>
                    <label for="3040-thc">20% - 40%</label>
                </li>
                <li class="list-item">
                    <input type="radio" id="4050-thc" name="thc" wire:model="thc" value="[4000, 5000]"/>
        ...
        <div class="shop_aside-block shop_aside-block--cbd">
            ...
            <ul class="list">
                <li class="list-item">
                    <input type="radio" id="010-cbd" name="cbd" wire:model="cbd" value="[0, 1000]"/>
                    <label for="010-cbd">0% - 10%</label>
                </li>
                <li class="list-item">
                    <input type="radio" id="1020-cbd" name="cbd" wire:model="cbd" value="[1000, 2000]" />
                    <label for="1020-cbd">10% - 20%</label>
                </li>
                <li class="list-item">
                    <input type="radio" id="3040-cbd" name="cbd" wire:model="cbd" value="[2000, 4000]" />
                    <label for="3040-cbd">20% - 40%</label>
                </li>
                <li class="list-item">
                    <input type="radio" id="4050-cbd" name="cbd" wire:model="cbd" value="[4000, 5000]"/>
...
<?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/front/livewire/filter-aside.blade.php ENDPATH**/ ?>