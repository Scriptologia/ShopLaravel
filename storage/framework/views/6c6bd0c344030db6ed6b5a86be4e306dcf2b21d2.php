...
<!-- fgEmojiPicker js -->
<script src="<?php echo e(URL::asset('admin/assets/libs/fg-emoji-picker/fg-emoji-picker.min.js')); ?>"></script>

<!-- chat init js -->
<script src="<?php echo e(URL::asset('admin/assets/js/pages/chat.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/apps-chat.blade.php ENDPATH**/ ?>