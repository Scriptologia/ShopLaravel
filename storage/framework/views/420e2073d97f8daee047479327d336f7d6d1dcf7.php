    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="#sidebarEcommerce" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEcommerce"><?php echo app('translator')->get('translation.ecommerce'); ?></a>
                    <div class="collapse menu-dropdown" id="sidebarEcommerce">
                        <ul class="nav nav-sm flex-column">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Product::class)): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.products')); ?>" class="nav-link"><?php echo app('translator')->get('translation.products'); ?>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Category::class)): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.categories')); ?>" class="nav-link"><?php echo app('translator')->get('admin.category.categories'); ?>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Tag::class)): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.tags')); ?>" class="nav-link"><?php echo app('translator')->get('admin.tags.tags'); ?>
                                </a>
                            </li>
                            <?php endif; ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.product.view')); ?>" class="nav-link"><?php echo app('translator')->get('translation.product-Details'); ?> </a>
                            </li>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Role::class)): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.product.create')); ?>" class="nav-link"><?php echo app('translator')->get('translation.create-product'); ?></a>
                            </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Order::class)): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.orders')); ?>" class="nav-link"><?php echo app('translator')->get('translation.orders'); ?></a>
                            </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\User::class)): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.users')); ?>" class="nav-link"><?php echo app('translator')->get('translation.customers'); ?>
                                </a>
                            </li>
                            <?php endif; ?>
                            <li class="nav-item">
                ...
                </li><!-- Мое меню - коммерция-->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarEmails" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarEmails">
                        <ul class="nav nav-sm flex-column">
                            <?php if( Auth::user()->can('viewAny', App\Model\Role::class) || Auth::user()->can('viewAny',  App\Model\Permission::class) ): ?>
                            <li class="nav-item">
                                <a href="#sidebarSignIn" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignIn"><?php echo app('translator')->get('admin.roles-and-permissions'); ?></a>
                                <div class="collapse menu-dropdown" id="sidebarSignIn">
                                    <ul class="nav nav-sm flex-column">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Role::class)): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('admin.roles')); ?>" class="nav-link"><?php echo app('translator')->get('admin.roles'); ?>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Permission::class)): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('admin.permissions')); ?>" class="nav-link"><?php echo app('translator')->get('admin.permissions'); ?>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                            ...
                            <?php endif; ?>
                            <li class="nav-item">
                                <a href="#sidebarEmail" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEmail"><?php echo app('translator')->get('admin.emails.emails'); ?></a>
                                <div class="collapse menu-dropdown" id="sidebarEmail">
                                    <ul class="nav nav-sm flex-column">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewAny', App\Models\Email::class)): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('admin.emails')); ?>" class="nav-link"><?php echo app('translator')->get('admin.emails.emails'); ?>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarSignUp" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignUp"><?php echo app('translator')->get('translation.signup'); ?> </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarEcommerce0" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEcommerce0"><?php echo app('translator')->get('translation.ecommerce'); ?>

                                </a>
                                <div class="collapse menu-dropdown" id="sidebarEcommerce0">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('admin.products')); ?>" class="nav-link"><?php echo app('translator')->get('translation.products'); ?>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('admin.product.view')); ?>" class="nav-link"><?php echo app('translator')->get('translation.product-Details'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('admin.product.create')); ?>" class="nav-link"><?php echo app('translator')->get('translation.create-product'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
...
<?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>