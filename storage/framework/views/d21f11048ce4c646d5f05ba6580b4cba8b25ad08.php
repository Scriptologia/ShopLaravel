<?php $__env->startSection('title', 'Home | Herbalist'); ?>
<?php $__env->startSection('data-page', 'home'); ?>
                ...
                <div class="container">
                    <ul class="categories_list d-flex flex-wrap">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <?php echo $__env->make('front.partials.category-item', $category, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="wrapper d-flex flex-column">
                                    <div class="media">
                                        ...
                                        <picture>
                                            <source data-srcset="<?php echo e(Storage::disk('image')->url($product->img_main)); ?>" srcset="<?php echo e(Storage::disk('image')->url($product->img_main)); ?>" type="image/webp" />
                                            <img class="lazy" data-src="<?php echo e(Storage::disk('image')->url($product->img_main)); ?>" src="<?php echo e(Storage::disk('image')->url($product->img_main)); ?>" alt="media" />
                                        </picture>
                                    </div>
                                    <div class="main d-flex flex-column">
                                        ...
                                        <div class="main_price">
                                            <span class="price">$<?php echo e(number_format($product->price/100,2 , '.', ',')); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('front/css/index2.min.css')); ?>" />
<?php $__env->stopPush(); ?>
<?php $__env->startPush('js'); ?>
<script src="<?php echo e(asset('front/js/index.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/front/index.blade.php ENDPATH**/ ?>