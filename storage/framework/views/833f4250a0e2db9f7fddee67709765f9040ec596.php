...
<link href="<?php echo e(URL::asset('admin/assets/libs/dragula/dragula.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo e(URL::asset('admin/assets/libs/dragula/dragula.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('admin/assets/libs/dom-autoscroller/dom-autoscroller.min.js')); ?>"></script>

<script src="<?php echo e(URL::asset('admin/assets/js/pages/todo.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/apps-todo.blade.php ENDPATH**/ ?>