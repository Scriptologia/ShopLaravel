...
<?php echo app('translator')->get('front.search.seach-by-products'); ?>
    </h4>
    <form class="form form--search" data-type="searchProducts" action="#" method="post" wire:submit.prevent="searchProducts">
        <input class="field required" wire:model="search" type="text" placeholder="<?php echo app('translator')->get('front.search.search'); ?>..." name="search"/>
        <button class="btn" type="submit" >
            <?php echo app('translator')->get('front.search.search'); ?></button>
    </form>
</div><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/front/livewire/search-products.blade.php ENDPATH**/ ?>