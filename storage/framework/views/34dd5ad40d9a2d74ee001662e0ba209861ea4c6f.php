...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('/admin/assets/libs/fullcalendar/fullcalendar.min.css')); ?>" rel="stylesheet">
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('admin/assets/libs/fullcalendar/fullcalendar.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('admin/assets/js/pages/calendar.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/apps-calendar.blade.php ENDPATH**/ ?>