            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <button type="button" class="btn w-sm btn-danger " id="delete-record"><?php echo app('translator')->get('admin.yes-delete'); ?></button>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        var routes = {
            apiCategories: '<?php echo e(route('admin.api.categories')); ?>',
            apiCategory: {
                edit :'<?php echo e(route('admin.api.category.edit')); ?>',
                delete :'<?php echo e(route('admin.api.category.delete')); ?>',
                update :'<?php echo e(route('admin.api.category.update')); ?>',
            }
        };
    </script>
    ...
    <script src="<?php echo e(URL::asset('admin/assets/js/pages/category.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('/admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/categories.blade.php ENDPATH**/ ?>