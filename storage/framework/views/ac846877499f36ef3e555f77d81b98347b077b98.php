                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <img src="<?php echo e(URL::asset('admin/assets/images/products/img-8.png')); ?>" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="<?php echo e(URL::asset('/admin/apps-ecommerce-product-details')); ?>"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <img src="<?php echo e(URL::asset('/admin/assets/images/products/img-7.png')); ?>" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="<?php echo e(URL::asset('/admin/apps-ecommerce-product-details')); ?>"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <img src="<?php echo e(URL::asset('/admin/assets/images/products/img-3.png')); ?>" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="<?php echo e(URL::asset('/admin/apps-ecommerce-product-details')); ?>"
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0 vstack gap-3">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?php echo e(URL::asset('/admin/assets/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm rounded shadow">
                                </div>
                                <div class="flex-grow-1 ms-3">
