                    ...
                    <div class="card-header border-0">
                        <div class="row g-4">
                            <div class="col-sm-auto">
                                <div>
                                    <a href="<?php echo e(route('admin.product.create')); ?>" class="btn btn-success" id="addproduct-btn"><i
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('admin/assets/js/pages/product.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/products.blade.php ENDPATH**/ ?>