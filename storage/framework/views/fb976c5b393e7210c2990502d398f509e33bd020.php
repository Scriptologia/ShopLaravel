                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto">
                            <div>
                                ...
                                <a href="<?php echo e(route('admin.api.users.export')); ?>" type="button" class="btn btn-info bg-success"><i class="ri-upload-2-fill align-bottom me-1"></i> Export</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <button type="button" class="btn w-sm btn-danger " id="delete-customer"><?php echo app('translator')->get('admin.yes-delete'); ?></button>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        var routes = {
            apiImport: '<?php echo e(route('admin.api.users.import')); ?>',
            apiExport: '<?php echo e(route('admin.api.users.export')); ?>',
    ...
    <script src="<?php echo e(URL::asset('admin/assets/js/pages/user.js')); ?>"></script>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/users.blade.php ENDPATH**/ ?>