...
<link rel="stylesheet" href="<?php echo e(URL::asset('admin/assets/libs/@simonwep/@simonwep.min.css')); ?>" /> <!-- 'classic' theme -->
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(URL::asset('admin/assets/libs/@simonwep/@simonwep.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('admin/assets/js/pages/form-pickers.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/admin/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/admin/forms-pickers.blade.php ENDPATH**/ ?>