<?php $__env->startSection('title', 'News | Herbalist'); ?>
<?php $__env->startSection('data-page', 'news2'); ?>
            ...
            <div class="container d-lg-flex justify-content-between">
                            ...
                            <div class="news_list-item_wrapper d-flex flex-column">
                                <div class="media">
                                    <picture>
                                        ...
                                        <img class="lazy" data-src="front/img/placeholder.jpg" src="front/img/placeholder.jpg" alt="post" />
                                    </picture>
                                </div>
                                <div class="main d-flex flex-column justify-content-between">
                                    ...
                                    <a class="main_title main_title--bookmarked" href="<?php echo e(route('post')); ?>" target="_blank" rel="noopener norefferer">
                        ...
                        <li class="news_list-item col-md-6" data-order="2">
                            <div class="news_list-item_wrapper d-flex flex-column">
                                ...
                                <div class="main d-flex flex-column justify-content-between">
                                    ...
                                    <a class="main_title" href="<?php echo e(route('post')); ?>" target="_blank" rel="noopener norefferer">
                                        <i class="icon-bookmark icon"></i>
                ...
                <div class="widgets">
                    ...
                    <div class="widgets-item widgets-item--recent">
                        ...
                        <ul class="list">
                            <li class="list-item">
                                <a class="d-flex flex-column flex-sm-row align-items-sm-center" href="<?php echo e(route('post')); ?>">
                                    <span class="media">
                                        <picture>
                                            <source
...
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('front/css/news2.min.css')); ?>" />
<?php $__env->stopPush(); ?>

<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\OpenServer\domains\ShopLaravel\resources\views/front/blog.blade.php ENDPATH**/ ?>