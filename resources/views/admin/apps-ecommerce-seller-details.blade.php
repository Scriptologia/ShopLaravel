...
@endsection
@section('css')
    <link href="{{ URL::asset('admin/assets/libs/gridjs/gridjs.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('admin/assets/libs/swiper/swiper.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@section('script')
    ...
    <script src="{{ URL::asset('admin/assets/js/pages/seller-details.init.js') }}"></script>
