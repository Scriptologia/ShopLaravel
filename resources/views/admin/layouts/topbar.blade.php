            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none"
                        ...
                        @case('ru')
                            <img src="{{ URL::asset('/admin/assets/images/flags/russia.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('it')
                            <img src="{{ URL::asset('/admin/assets/images/flags/italy.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('sp')
                            <img src="{{ URL::asset('/admin/assets/images/flags/spain.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('ch')
                            <img src="{{ URL::asset('/admin/assets/images/flags/china.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('fr')
                            <img src="{{ URL::asset('/admin/assets/images/flags/french.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('gr')
                            <img src="{{ URL::asset('/admin/assets/images/flags/germany.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @default
                            <img src="{{ URL::asset('/admin/assets/images/flags/us.svg') }}" class="rounded " alt="Header Language" height="18">
                    @endswitch
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="{{ url('index/en') }}" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="{{ URL::asset('admin/assets/images/flags/us.svg') }}" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="{{ url('index/sp') }}" class="dropdown-item notify-item language" data-lang="sp"
                            title="Spanish">
                            <img src="{{ URL::asset('admin/assets/images/flags/spain.svg') }}" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="{{ url('index/it') }}" class="dropdown-item notify-item language" data-lang="it"
                            title="Italian">
                            <img src="{{ URL::asset('admin/assets/images/flags/italy.svg') }}" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="{{ url('index/ru') }}" class="dropdown-item notify-item language" data-lang="ru"
                            title="Russian">
                            <img src="{{ URL::asset('admin/assets/images/flags/russia.svg') }}" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="{{ url('index/ch') }}" class="dropdown-item notify-item language" data-lang="ch"
                            title="Chinese">
                            <img src="{{ URL::asset('admin/assets/images/flags/china.svg') }}" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="{{ url('index/fr') }}" class="dropdown-item notify-item language" data-lang="fr"
                            title="French">
                            <img src="{{ URL::asset('admin/assets/images/flags/french.svg') }}" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('admin/assets/images/products/img-1.png') }}"
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('admin/assets/images/products/img-2.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('admin/assets/images/products/img-3.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('admin/assets/images/products/img-6.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('admin/assets/images/products/img-5.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="apps-ecommerce-product-details"
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->avatar != ''){{ Storage::disk('image')->url(Auth::user()->avatar) }}@else{{ URL::asset('admin/assets/images/users/avatar-1.jpg') }}@endif"
                                alt="Header Avatar">
