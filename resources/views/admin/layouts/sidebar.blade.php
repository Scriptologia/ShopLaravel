            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarEcommerce">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.products')}}" class="nav-link">@lang('translation.products')
                                </a>
                            </li>
                            @endcan
                            @can('viewAny', App\Models\Category::class)
                            <li class="nav-item">
                                <a href="{{route('admin.categories')}}" class="nav-link">@lang('admin.category.categories')
                                </a>
                            </li>
                            @endcan
                            @can('viewAny', App\Models\Tag::class)
                            <li class="nav-item">
                                <a href="{{route('admin.tags')}}" class="nav-link">@lang('admin.tags.tags')
                                </a>
                            </li>
                            @endcan
                            <li class="nav-item">
                                <a href="{{route('admin.product.view')}}" class="nav-link">@lang('translation.product-Details') </a>
                            </li>
                            @can('create', App\Models\Role::class)
                            <li class="nav-item">
                                <a href="{{route('admin.product.create')}}" class="nav-link">@lang('translation.create-product')</a>
                            </li>
                            @endcan
                            @can('viewAny', App\Models\Order::class)
                            <li class="nav-item">
                                <a href="{{route('admin.orders')}}" class="nav-link">@lang('translation.orders')</a>
                            </li>
                            @endcan
                            @can('viewAny', App\Models\User::class)
                            <li class="nav-item">
                                <a href="{{route('admin.users')}}" class="nav-link">@lang('translation.customers')
                                </a>
                            </li>
                            @endcan
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarEmails">
                        <ul class="nav nav-sm flex-column">
                            @if ( Auth::user()->can('viewAny', App\Model\Role::class) || Auth::user()->can('viewAny',  App\Model\Permission::class) )
                            <li class="nav-item">
                                <a href="#sidebarSignIn" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignIn">@lang('admin.roles-and-permissions')</a>
                                <div class="collapse menu-dropdown" id="sidebarSignIn">
                                    <ul class="nav nav-sm flex-column">
                                        @can('viewAny', App\Models\Role::class)
                                        <li class="nav-item">
                                            <a href="{{route('admin.roles')}}" class="nav-link">@lang('admin.roles')
                                            </a>
                                        </li>
                                        @endcan
                                        @can('viewAny', App\Models\Permission::class)
                                        <li class="nav-item">
                                            <a href="{{route('admin.permissions')}}" class="nav-link">@lang('admin.permissions')
                                            </a>
                                        </li>
                                        @endcan
                                    </ul>
                            ...
                            @endif
                            <li class="nav-item">
                                <a href="#sidebarEmail" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEmail">@lang('admin.emails.emails')</a>
                                <div class="collapse menu-dropdown" id="sidebarEmail">
                                    <ul class="nav nav-sm flex-column">
                                        @can('viewAny', App\Models\Email::class)
                                        <li class="nav-item">
                                            <a href="{{route('admin.emails')}}" class="nav-link">@lang('admin.emails.emails')
                                            </a>
                                        </li>
                                        @endcan
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarSignUp" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignUp">@lang('translation.signup') </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarEcommerce0" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarEcommerce0">@lang('translation.ecommerce')
                                ...
                                <div class="collapse menu-dropdown" id="sidebarEcommerce0">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{route('admin.product.view')}}" class="nav-link">@lang('translation.product-Details')
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('admin.product.create')}}" class="nav-link">@lang('translation.create-product')
                                            </a>
                                        </li>
                                        <li class="nav-item">
