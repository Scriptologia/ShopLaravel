...
@endsection
@section('css')
<link href="{{ URL::asset('admin/assets/libs/dragula/dragula.min.css') }}" rel="stylesheet" type="text/css" />
...
<script src="{{URL::asset('admin/assets/libs/dom-autoscroller/dom-autoscroller.min.js')}}"></script>

<script src="{{URL::asset('admin/assets/js/pages/todo.init.js')}}"></script>
