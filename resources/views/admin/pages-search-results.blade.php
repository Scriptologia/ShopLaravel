...
@section('css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('admin/assets/libs/glightbox/glightbox.min.css') }}">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ URL::asset('admin/assets/libs/glightbox/glightbox.min.js') }}"></script>

    <!-- swiper js -->
    <script src="{{ URL::asset('admin/assets/libs/swiper/swiper.min.js') }}"></script>

    <!-- search-result init js -->
    <script src="{{ URL::asset('admin/assets/js/pages/search-result.init.js') }}"></script>
