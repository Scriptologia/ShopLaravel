...
@endsection
@section('css')
    <link href="{{ URL::asset('admin/assets/libs/jsvectormap/jsvectormap.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@section('script')
    ...
    <script src="{{ URL::asset('admin/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/pages/dashboard-analytics.init.js') }}"></script>
