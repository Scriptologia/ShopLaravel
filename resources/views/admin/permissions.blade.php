...
@section('script')
    <script>
        var routes = {
            apiPermissions: '{{route('admin.api.permissions')}}',
            apiPermission: {
                edit :'{{route('admin.api.permission.edit')}}',
                create :'{{route('admin.api.permission.create')}}',
                delete :'{{route('admin.api.permission.delete')}}',
                update :'{{route('admin.api.permission.update')}}',
            }
        };
    </script>
    ...
    <script src="{{ URL::asset('admin/assets/js/pages/permission.init.js') }}"></script>
