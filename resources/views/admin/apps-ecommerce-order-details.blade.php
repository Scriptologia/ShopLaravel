...
@section('content')
    ...
    <div class="row">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{URL::asset('/admin/apps-invoices-details')}}" class="btn btn-success btn-sm"><i
                            ...
                            @forelse($order->products as $product)
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <img src="{{Storage::disk('image')->url($product->img_main)}}" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{route('admin.product.view', $product)}}"
                                    ...
                                    <td class="fw-medium text-end">
                                        ${{$product->price * $product->pivot->quantity /100}}
                                    </td>
                                    @php
                                ...
                                <tr class="border-top border-top-dashed">
                                    ...
                                    <td colspan="2" class="fw-medium p-0">
                                        <table class="table table-borderless mb-0">
                                            ...
                                            <tr>
                                                <td>Sub Total :</td>
                                                <td class="text-end">${{$subTotal / 100}}</td>
                                            </tr>
                                            <tr>
                                                <td>Discount
                                                    {{--<span class="text-muted">(VELZON15)</span> : :--}}
                                                </td>
                                                <td class="text-end">-${{round($subDiscount / 100, 2)}}</td>
                                            </tr>
                                            <tr>
                                                @php
                                                $ShippingCharge = 65;
                                            ...
                                            <tr class="border-top border-top-dashed">
                                                ...
                                                <th class="text-end">${{($subTotal / 100) - round($subDiscount / 100, 2) + $ShippingCharge + $EstimatedTax}}</th>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
        ...
        <div class="col-xl-3">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{route('admin.user',$order->user)}}" class="link-secondary">View Profile</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled mb-0 vstack gap-3">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ Storage::disk('image')->url($order->user->avatar) }}" alt="" class="avatar-sm rounded shadow">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="fs-14 mb-1">{{$order->user->name.' '.$order->user->surname}}</h6>
            ...
            <!--end card-->
            {{--TODO сделать доставку и роль пользователя--}}
            {{--TODO сделать адрес доставки, возможно новую таблицу в БД--}}
            <div class="card">
                <div class="card-header">
