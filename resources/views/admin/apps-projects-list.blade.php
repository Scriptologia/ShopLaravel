                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-warning rounded p-2">
                                        <img src="{{ URL::asset('admin/assets/images/brands/slack.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-danger rounded p-2">
                                        <img src="{{ URL::asset('admin/assets/images/brands/dribbble.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="flex-grow-1">
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-3.jpg') }}" alt=""
                                ...
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-4.jpg') }}" alt=""
                                            class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-success rounded p-2">
                                        <img src="{{ URL::asset('admin/assets/images/brands/mail_chimp.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="flex-grow-1">
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-5.jpg') }}" alt=""
                                            class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-info rounded p-2">
                                        <img src="{{ URL::asset('admin/assets/images/brands/dropbox.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                ...
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-6.jpg') }}" alt=""
                                            class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-7.jpg') }}" alt=""
                                            class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="{{ URL::asset('admin/assets/images/users/avatar-8.jpg') }}" alt=""
                                            class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <img src="{{ URL::asset('admin/assets/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="Add Members">
                                    <div class="avatar-xxs">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-secondary rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('admin/assets/images/brands/dribbble.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('admin/assets/images/brands/slack.png') }}" alt="" height="32">
                        </div>
                    </div>
                    <div class="py-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    ...
                                    <img src="{{ URL::asset('admin/assets/images/users/avatar-9.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="James Clem">
                                    <img src="{{ URL::asset('admin/assets/images/users/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="Add Members">
                                    <div class="avatar-xxs">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-primary rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('admin/assets/images/brands/dropbox.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('admin/assets/images/brands/mail_chimp.png') }}" alt="" height="32">
                        </div>
                    </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('admin/assets/js/pages/project-list.init.js') }}"></script>
