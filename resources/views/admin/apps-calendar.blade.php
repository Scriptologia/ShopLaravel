...
@endsection
@section('css')
    <link href="{{ URL::asset('/admin/assets/libs/fullcalendar/fullcalendar.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ URL::asset('admin/assets/libs/fullcalendar/fullcalendar.min.js') }}"></script>
