...
@endsection
@section('css')
    <link href="{{ URL::asset('admin/assets/libs/jsvectormap/jsvectormap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('admin/assets/libs/swiper/swiper.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
@section('script')
    ...
    <script src="{{ URL::asset('/admin/assets/libs/jsvectormap/jsvectormap.min.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/libs/swiper/swiper.min.js') }}"></script>
    <!-- dashboard init -->
    <script src="{{ URL::asset('/admin/assets/js/pages/dashboard-ecommerce.init.js') }}"></script>
