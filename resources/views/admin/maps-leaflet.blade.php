...
@endsection
@section('css')
    <link href="{{ URL::asset('admin/assets/libs/leaflet/leaflet.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
@section('script')
    ...
    <script src="{{ URL::asset('/admin/assets/libs/leaflet/leaflet.min.js') }}"></script>
