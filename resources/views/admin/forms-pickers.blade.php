...
@endsection
@section('css')
<link rel="stylesheet" href="{{ URL::asset('admin/assets/libs/@simonwep/@simonwep.min.css') }}" /> <!-- 'classic' theme -->
@endsection
@section('content')
...
@endsection
@section('script')
<script src="{{ URL::asset('admin/assets/libs/@simonwep/@simonwep.min.js') }}"></script>
<script src="{{ URL::asset('admin/assets/js/pages/form-pickers.init.js') }}"></script>
