...
<link href="{{ URL::asset('admin/assets/libs/nouislider/nouislider.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
<script src="{{ URL::asset('admin/assets/js/pages/apps-nft-explore.init.js') }}"></script>
