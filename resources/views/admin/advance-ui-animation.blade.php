...
@endsection
@section('css')
    <link href="{{ URL::asset('/admin/assets/libs/aos/aos.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ URL::asset('/admin/assets/libs/aos/aos.min.js') }}"></script>
    <script src="{{ URL::asset('/admin/assets/libs/prismjs/prismjs.min.js') }}"></script>
    <script src="{{ URL::asset('/admin/assets/js/pages/animation-aos.init.js') }}"></script>
