                ...
                <div class="container">
                    <ul class="categories_list d-flex flex-wrap">
                        @foreach($categories as $category)
                             @include('front.partials.category-item', $category)
                        @endforeach
                    </ul>
                </div>
            </div>
                            ...
                            @foreach($products as $product)
                                ...
                                <div class="wrapper d-flex flex-column">
                                    <div class="media">
                                        ...
                                        <picture>
                                            <source data-srcset="{{Storage::disk('image')->url($product->img_main)}}" srcset="{{Storage::disk('image')->url($product->img_main)}}" type="image/webp" />
                                            <img class="lazy" data-src="{{Storage::disk('image')->url($product->img_main)}}" src="{{Storage::disk('image')->url($product->img_main)}}" alt="media" />
                                        </picture>
                                    </div>
...
@push('css')
    <link rel="stylesheet" href="{{asset('front/css/index2.min.css')}}" />
@endpush
@push('js')
