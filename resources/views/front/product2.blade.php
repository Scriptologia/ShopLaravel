...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/product2.min.css" />
    </head>
    <body>
        <header class="header d-flex flex-wrap align-items-center" data-page="product2" data-overlay="@@overlay">
                            ...
                            <div class="dropdown-menu collapse" id="pagesMenu">
                                <ul class="dropdown-list">
                                    ...
                                    <li class="list-item nav-item" data-page="404">
                                        <a class="dropdown-item" href="404.blade.php">Error Page</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <main>
            <section class="about section--nopb">
                <div class="container">
                    ...
                    <div class="about_main d-md-flex flex-nowrap justify-content-between align-items-start">
                        ...
                        <div class="about_wrapper" data-sticky="true">
                            <div class="about_main-info">
                                <div
                                    class="about_main-info_product d-sm-flex flex-md-column flex-xl-row align-items-center align-items-md-start align-items-xl-center justify-content-between"
                                >
                                ...
                                <p class="about_main-info_description">
                                    ...
                                    mauris pellentesque. Arcu felis bibendum ut tristique et egestas. Id semper risus in hendrerit gravida
                                    rutrum. Eu mi bibendum neque egestas congue
                                </p>
                                <div
                                    class="about_main-info_block d-flex flex-column flex-sm-row flex-md-column flex-xl-row align-items-sm-center align-items-md-start align-items-xl-center"
                                >
                                ...
                                <div class="about_main-info_list d-sm-flex flex-md-column flex-xl-row justify-content-between">
                                    ...
                                    <div class="column">
                                        ...
                                        <div class="list-item">
                                            ...
                                            <span class="value">Cannabis, flower</span>
                                        </div>
                                        <div class="list-item">
                                        ...
                                        <div class="wrapper">
                                            ...
                                            >
                                                <p class="text">
                                                    ...
                                                    scelerisque mauris pellentesque. Arcu felis bibendum ut tristique et egestas. Id semper
                                                    risus in hendrerit gravida rutrum. Eu mi bibendum neque egestas congue.
                                                </p>
                                                <p class="text">
                                                    Dignissim enim sit amet venenatis. At tellus at urna condimentum mattis pellentesque id
                                                    nibh. Sollicitudin ac orci phasellus egestas tellus rutrum. Eget mi proin sed libero
                                                    enim sed. Quisque non tellus orci ac auctor augue mauris. Sit amet luctus venenatis
            ...
            <!-- Related products content start -->
            <aside class="related section">
                <div class="container">
                    <div class="related_header">
                        <h2 class="related_header-title">Related Products</h2>
                        <p class="related_header-text">
                    ...
                    <div class="related_slider swiper">
                        <div class="swiper-wrapper">
                            <div class="related_slider-slide swiper-slide">
