...
@lang('front.search.seach-by-products')
    </h4>
    <form class="form form--search" data-type="searchProducts" action="#" method="post" wire:submit.prevent="searchProducts">
        <input class="field required" wire:model="search" type="text" placeholder="@lang('front.search.search')..." name="search"/>
        <button class="btn" type="submit" >
            @lang('front.search.search')</button>
    </form>
</div>