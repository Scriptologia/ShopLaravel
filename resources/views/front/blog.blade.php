            ...
            <div class="container d-lg-flex justify-content-between">
                        ...
                        <li class="news_list-item col-md-6" data-order="1">
                            <div class="news_list-item_wrapper d-flex flex-column">
                                ...
                                <div class="main d-flex flex-column justify-content-between">
                                    ...
                                    <a class="main_title main_title--bookmarked" href="{{route('post')}}" target="_blank" rel="noopener norefferer">
                        ...
                        <li class="news_list-item col-md-6" data-order="2">
                            <div class="news_list-item_wrapper d-flex flex-column">
                                ...
                                <div class="main d-flex flex-column justify-content-between">
                                    ...
                                    <a class="main_title" href="{{route('post')}}" target="_blank" rel="noopener norefferer">
                                        <i class="icon-bookmark icon"></i>
                ...
                <div class="widgets">
                    ...
                    <div class="widgets-item widgets-item--recent">
                        ...
                        <ul class="list">
                            <li class="list-item">
                                <a class="d-flex flex-column flex-sm-row align-items-sm-center" href="{{route('post')}}">
                                    <span class="media">
                                        <picture>
                                            <source
...
@push('css')
    <link rel="stylesheet" href="{{asset('front/css/news2.min.css')}}" />
@endpush
