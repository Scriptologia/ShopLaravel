...
@section('content')
    ...
    <main>
        ...
        <div class="shop-wrapper section">
            <div class="container d-flex d-lg-grid flex-column">
                <div class="promo_banner promo_banner--big">
                    ...
                    <a class="promo_banner-btn btn" href="#">@lang('front.shop-now')</a>
                </div>
                @livewire('filtered-products')
                @livewire('filter-aside')
            </div>
        </div>
        ...
        <section class="sale section">
            ...
            <div class="container">
                <h2 class="sale_header">@lang('front.items-on-sale')</h2>
                        ...
                        <div class="sale_swiper-slide swiper-slide">
                            <div class="products_list-item_wrapper d-flex flex-column">
                                <div class="media">
                                    ...
                                    <span class="label">@lang('front.sale')</span>
                                </div>
                                <div class="main d-flex flex-column align-items-center justify-content-between">
                                    ...
                                    <a class="btn btn--green" href="#">@lang('front.add-to-cart')</a>
                                </div>
                            </div>
                        </div>
                        <div class="sale_swiper-slide swiper-slide">
                ...
                <div class="wrapper">
                    ...
                    <div class="newsletter_content">
                        <div class="newsletter_header">
                            <h2 class="newsletter_header-title">@lang('front.sign-up-for-our-newsletter')</h2>
                            <p class="newsletter_header-text">
                                @lang('front.sign-up-newsletter-after-text')
                            </p>
                        </div>
                        <form class="newsletter_form d-sm-flex" data-type="newsletter" action="#" method="post">
                            ...
                            <button class="newsletter_form-btn btn" type="submit">@lang('front.send')</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <section class="seo section">
            <div class="container">
                <h2 class="seo_header">@lang('front.seo-text')</h2>
...
@push('css')
    <link rel="stylesheet" href="{{asset('front/css/shop2.min.css')}}" />
@endpush
